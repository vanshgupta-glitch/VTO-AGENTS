# Orchestration-Researcher — Mission Brief

## Role
Research cron/heartbeat configurations for VTO pipeline scheduling and automation.

## Goal
Design automated task cycling, context hygiene triggers, adversarial review scheduling, and failure mode detection for the VTO swarm.
...
- Poll interval rationale and concurrent-child safety gate
- Idempotency guard and watchdog-reclaim path
